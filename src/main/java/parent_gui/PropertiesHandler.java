 ...
 * PropertiesHandler
 *
 * Creates and returns propertoes from a file stream
 *
...
public class PropertiesHandler
{
	...
	public final static String DEFAULT_EXT = ".prop"; 
	...
	*/
	public PropertiesHandler(String name) throws NoPropertiesException
	{
		try 
		{
			...
			File file = new File(classLoader.getResource(name+DEFAULT_EXT).getFile());
