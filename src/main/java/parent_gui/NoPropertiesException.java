 ...
 *
 * When a properties file cannot be found this exception is thrown
 *
 *  @author Greg Ross, Andrew Didsbury
 */
package parent_gui;

public class NoPropertiesException extends Exception
{
	public static final String NO_FILE     = "No File Found";
	public static final String NO_PROPERTY = "No Property Found";
	...
	*
	* @param msg The message in this exception
	*/
