...
public class SelectionHandler implements java.io.Serializable
{
    ...
    /**
     * constructor: Creates a new empty Selection handler with an initial 
     * size of 0
     *
     */
     ...
     */ 
    public SelectionHandler(int size, DataItemCollection dataItems)
    {
	this();
	this.size = size;
	...
	for (int i = 0 ; i < size ; i++ ) 
	{
	    ...
	    all.add(new Integer(dataItems.getDataItem(i).getID()));
	    allIDs.add(new Integer(dataItems.getDataItem(i).getID()));
	    selectedIndices.add(new Integer(dataItems.getDataItem(i).getID()));
	}
    }
	...
	for (int i = 0 ; i < size ; i++)
	    selected.set(i , new Boolean(selectedIndices.contains(new Integer(dataItems.getDataItem(i).getID()))));							
