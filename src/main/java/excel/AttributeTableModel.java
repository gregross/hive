...
public class AttributeTableModel extends AbstractTableModel implements java.io.Serializable
{
	// Versioning for serialisation
	
	static final long serialVersionUID = 50L;
	
	private String[] columnNames = {"Attribute", "Export?"};
	...
	private ExcelExport parentForm;
	
	public AttributeTableModel(Object[][] data, ExcelExport parentForm)
	{
		this.data = data;
