...
/** Class managing a set of colour scales.
	...
	Color scales should be implemented as classes in the
	ColorScales package having a static member named 'rgb'
...
public class ColorScales
{
	...
	{
		try {
			Class cl = Class.forName("ColorScales." + name);
