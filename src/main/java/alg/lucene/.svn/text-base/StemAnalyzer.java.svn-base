...
public class StemAnalyzer extends Analyzer
{
	...
	private static final String SMART_STOP_WORDS[] =
	{
	   ...
	   "after", "afterwards", "again", "against", "all", "allow", "allows", "almost",
	...
	public StemAnalyzer()
	{
		stopTable = StopFilter.makeStopTable(SMART_STOP_WORDS);
	}
	...
	public TokenStream tokenStream(String sText)
	{
		TokenStream result = new StandardTokenizer(new StringReader(sText));
		result = new StandardFilter(result);
		result = new LowerCaseFilter(result);
		result = new StopFilter(result, stopTable);
		result = new PorterStemFilter(result);
