 ...
 * DoubleSlider
 *
 * This is a double-ended slider used in conjunction with
 * the paralleld coordinates
 *
 * @author Jonathan Paisley, Alistair Morrison
 *
 * ------------- Original notice -------------
 *
...
public class PCDoubleSlider extends JPanel 
{
	...
	*/
    ...
    public PCDoubleSlider(int orientation,double minValue,double maxValue){
	...
	*/
	...
	private class EventsHandler implements	LayoutManager, 
