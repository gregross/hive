 ...
 * SortColumnRenderer
 * 
 * This renders the icons in the table header when sorting
 *  
 *  @author
 */ 
...
public class SortColumnRenderer extends DefaultTableCellRenderer implements java.io.Serializable
{
	...
	public SortColumnRenderer(){}
	
	public SortColumnRenderer(DataViewerTable jtable) 
	{
		this.jtable = jtable;
	}
	
	public void setIcon(ImageIcon sortIcon)
	{
		l.setIcon(sortIcon);
	}
