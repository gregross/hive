 ...
 * Algorithmic testbed
 *
 * A subclass of XYSeries that does not sort values according to the x-axis
 *
 *  @author Greg Ross
 */
 ...
 {	
	...
	public CustomXYSeries(String name)
	{
		super(name);
	...
	/**
	* Override the add method of the parent CXSeries class so that
	* the series is not sorted on the x-axis values
	*/
