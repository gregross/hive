								...
								java.io.Serializable
{
	...
	private NumberFormat doubleFormat;
    	...
    	public NMDSControlPanel(FastNMDS NMDS_Module)
	{
		// Enlarge the module
	...
	*/
	...
	{	
		...
		if (NMDS_Module.getConvergenceTrigger() == FastNMDS.ITERATIVE_CONVERGENCE)
		{
		...
		else if (NMDS_Module.getConvergenceTrigger() == FastNMDS.MONOTONICITY_CONVERGENCE)
		{	
	...
	public void actionPerformed(ActionEvent e)
	{
			...
			(e.getSource() == rbMonoTrigger))
		{
			...
			if (rbIterationTrigger.isSelected())
				NMDS_Module.setConvergenceTrigger(FastNMDS.ITERATIVE_CONVERGENCE);
			else
				NMDS_Module.setConvergenceTrigger(FastNMDS.MONOTONICITY_CONVERGENCE);
