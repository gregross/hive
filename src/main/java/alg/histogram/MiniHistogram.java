...
public class MiniHistogram extends JPanel implements SelectionChangedListener
{
    ...
    private DoubleSliderPanel sliderPanel;
    ...
    public MiniHistogram(ArrayList data, Object min, Object max, DoubleSliderPanel sliderPanel, DataItemCollection dataItems)
    {
	this(data, min, max, HORIZONTAL, sliderPanel, dataItems);
    }
    ...
    public MiniHistogram(ArrayList data,
			 Object min, Object max,
			 int orientation, DoubleSliderPanel sliderPanel, DataItemCollection dataItems)
    {
	this.data        = data;
	...
	for ( int i = 0 ; i < data.size() ; i++ ) 
	{
		...
		{    
		    ...
		    bins.set( k, new Integer(((Integer)bins.get(k)).intValue() + 1));
		    ...
		    if (sliderPanel.getSelectionHandler() != null)
		    {
			    if ( sliderPanel.getSelectionHandler().getState(i) &&
	...
	for ( int i = 0 ; i < numBins ; i++ )
	{
	    ...
	    while ( itr.hasNext() )
	    {
		    ...
		    Integer key = new Integer((dataItems.getDataItem(((Integer)itr.next()).intValue())).getID());
